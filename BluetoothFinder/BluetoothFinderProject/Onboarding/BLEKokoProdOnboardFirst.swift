...
struct BLEKokoProdOnboardFirst: View {
    ...
    var body: some View {
        NavigationStack {
            VStack(spacing: 8) {
                ...
                Text("Find your Bluetooth\ndevices with ease")
                    .multilineTextAlignment(.center)
                    .foregroundStyle(.white)
                    .font(.system(size: 32, weight: .semibold))

                Text("Effortlessly locate Bluetooth-compatible devices\nand view their positions")
                    .multilineTextAlignment(.center)
                    .foregroundStyle(.white)
                ...
                .navigationDestination(isPresented: $navigate) {
                    BLEKokoProdOnboardSecond(apphudService: apphudService)
                }
            }
